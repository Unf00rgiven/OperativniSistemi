/*
Napraviti konkurentni program koji stvara zadati broj niti a potom u svakoj niti ispisuje redni broj te niti. Korisnik prilikom pokretanja 
programa zadaje željeni broj niti. Prilikom instanciranja niti njoj se prosleđuje njen redni broj koji ona potom ispisuje.
...
2)
Funkcija "izracunaj" ima jedan parametar - broj niti koje treba kreirati. Ova funkcija treba da pokrene onoliko niti koliko je navedeno u parametru 
a kao funkciju tih niti treba da iskoristi funkciju koja je implementirana u prvom delu zadatka (funkciju "ispisi").
