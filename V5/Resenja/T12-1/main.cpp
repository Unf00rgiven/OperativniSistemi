...
Korespondentni elementi su elementi na istim pozicijama -- npr. sabiraju se element na poziciji 0 vektora A i element na poziciji 0 vektora B i na
poziciju 0 rezultujućeg vektora C se postavlja rezultat tog sabiranja. Proces se nastavlja sa pozicijom 1 i tako do kraja ulaznih vektora.
...
2)
Funkcija "izracunaj" dobija dva parametra - dva ulazna vektora koji sadrže neki broj cifara. Ova funkcija treba da pokrene onoliko konkurentnih niti koliko je elemenata u ulaznim vektorima.
Svaka nit treba da obrađuje po jedan par elemenata i za sabiranje treba da koristi funkciju "saberiPar" koja je realizovana u prvom delu zadatka. Sledi primer:
...
Nakon što niti obave svoje operacije i završe se, funkcija "izracunaj" treba da ukupan rezultat sabiranja (vektor C) vrati kao svoj rezultat. Važno je da taj vektor ima isti broj
elemenata kao i ulazni vektori A i B i da redosled cifara u njemu bude u skladu sa očekivanim (npr da cifra na poziciji 4 odgovara zbiru elemenata na poziciji 4 vektora A i poziciji 4 vektora B).
...
// Sabiraju se elementi na poziciji 3 vektora A i poziciji 0 vektora B
