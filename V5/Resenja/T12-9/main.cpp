/*
Napraviti konkurentan program koji obračunava ukupnu cenu prilikom kupovine više proizvoda. Da bi se ovo izračunavanje moglo uraditi neophodno je da postoji cenovnik, koji predstavlja mapu u 
kojoj je ključ naziv proizvoda (string) a podatak je cena proizvoda (double). Pored cenovnika, ulaz predstavlja lista kupljenih proizvoda (obavezno STL lista) koja sadrži nazive proizvoda koji su kupljeni.
...
2)
Funkcija "izracunaj" takođe kao parametre prima listu kupljenih proizvoda i cenovnik. Ova funkcija treba da pokrene novu nit a za funkciju niti treba da se koristi funkcija "obracunajUkupno"
koja je realizovana u prvom delu zadatka.
