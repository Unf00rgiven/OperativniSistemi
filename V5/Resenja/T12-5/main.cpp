...
Napomena: redosled reči u rečnicima (i ulaznom i u onom koji je dobijen kao rezultat pravljenja rečnika) ne mora biti u redosledu u kojem se reči pojavljuju
u programu (usled osobine asocijativnih kolekcija da one interno menjaju raspored svojih elemenata).
...
2)
Funkcija "izracunaj" ima jedan parametar - ulazni rečnik (mapu reči kod koje je ključ reč na engleskom a podatak prevod te reči na srpski). Ova funkcija treba da pokrene novu nit 
a kao funkciju te niti treba da iskoristi funkciju koja je implementirana u prvom delu zadatka (funkciju "napraviRecnik").
