/*
    ...
    formatu je 8000 32-bitnih float verdnosti, odn. 32 kilobajta. Svaki sempl predstavlja 25ms
    ...
    najskoriji sempl koji se 'pusta' (ispisuje na ekran). Pozadinska nit, i pozadniska nit tajmera se
...
class Dijagnostika{
    ...
    public:
        ...
        /*
            ...
            10-12| -  | Znak - zaci da je u ovoj kategoriji signal na poziciji 2, tj. 11
...
class Bafer {
    ...
    public:
        ...
        void load(Sample& out){
            //TODO B Napraviti thread-safe uzitavanje uzorka ovde u sladu sa zadatkom
        }
...
void testirajB(Bafer& b){
    //TODO B Pokrenuti tri niti koje ivrsavaju toneGenerator sa parametrima 440Hz, 554.356Hz
    //660Hz, duzinama od po 1s, i jacinom zvuka od 30%. 
    //kada niti zavrse, ispisati ceo bafer. 
}


//TODO C Napraviti ovde telo niti koje sluzi da automatsk tempirano, 'pusta' (ispisuje na ekran)
