/*
    ...
    da se moze na zahtev korisnika ugasiti. Komprimovanje ode ne radi realokaciju nicega, sve sto radi
...
class Memorija{
    ...
    public:
        Memorija(int kapacitet, Dijagnostika& dd) {
...
void testirajA(Dijagnostika& d){
    ...
    for(int i = 0; i < 8; i++){
        ...
        //racuna 128 prostih brojve pocevski od 0 za prvu nit, 2000 za drugu, 4000 za trecu i tako dalje
...
void testirajB(Memorija& mem){
    ...
    //TODO B join-ovati sve niti pokrenute. 
}
